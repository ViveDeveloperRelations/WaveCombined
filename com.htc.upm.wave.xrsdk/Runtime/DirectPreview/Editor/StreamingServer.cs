...
namespace Wave.XR.DirectPreview.Editor
{
	public class StreamingServer
	{
		...
		{
			var absolutePath = Path.GetFullPath(DirectPreviewAPK.DirectPreviewBinaryFolder+ "/RRServer/RRserver.exe");
		...
		public static void StartStreamingServer()
		{
			if (isStreamingServerExist())
			{
				try
				{
					var absolutePath = Path.GetFullPath(DirectPreviewAPK.DirectPreviewBinaryFolder+"/RRServer");
